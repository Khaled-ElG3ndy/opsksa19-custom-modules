...
**Generator Rental ERP — Preventive & corrective maintenance**

Part of the **Generator Rental ERP** vertical suite (Odoo 18 Community) for a
KSA generator-rental operation.

- **Module prefix:** `gr_`
- **Depends on:** gr_security_base,gr_fleet_base,gr_rental_order,mail
- **Dependency layer position:** 8 of 10
...
sudo -u odoo18 /opt/odoo18/venv/bin/python3 /opt/odoo18/odoo/odoo-bin \
  -c /etc/odoo-gen/odoo-gen.conf -d generator -i gr_maintenance --stop-after-init
